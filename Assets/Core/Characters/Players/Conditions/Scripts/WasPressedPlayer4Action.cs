...
{
    /// <summary>
    /// Checks to see if the player pressed Player 4 Action.
    /// </summary>
    [CreateAssetMenu(fileName = "Was P4 Action Pressed", menuName = "Behavior Tree Pattern/New Condition/Common/Player/Was P4 Action Pressed")]
    public class WasPressedPlayer4Action : Condition
    {
