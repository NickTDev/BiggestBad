...
{
    /// <summary>
    /// Checks if the enemy is not in range of the player and out of movement
    /// </summary>
    [CreateAssetMenu(fileName = "Out of Movement", menuName = "Behavior Tree Pattern/New Condition/Common/Enemy/Out of Movement")]
    public class IsOutOfMovement : Condition
    {
